...
echo ${seed}
    ...
    time accelerate launch --gpu_ids $1 --main_process_port=$2 --config_file /home/yonghyun/.cache/huggingface/accelerate/default_config.yaml train_unconditional.py \
    ...
    --seed=${seed} \
    --wandb_name="CIFAR2-automobile-horse-$3-counter"
